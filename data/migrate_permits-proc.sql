CALL PROC_MIGRATE_NEW_USER_PERMITS(2892, '50610', 1061);

SELECT *
FROM DAT_KEBS_PERMIT_TRANSACTION
WHERE PERMIT_REF_NUMBER = '50610';
...
-- where PERMIT_NUMBER = C_PERMIT.PERMIT_NUMBER;
                ...
                qry := 'INSERT INTO DAT_KEBS_PERMIT_TRANSACTION (DATE_OF_ISSUE, EFFECTIVE_DATE, KS_NUMBER,
