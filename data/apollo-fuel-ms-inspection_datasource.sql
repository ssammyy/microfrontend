...
SELECT a.REFERENCE_NUMBER,a.TRANSACTION_DATE,a.TIMELINE_START_DATE,a.TIMELINE_END_DATE,
...
SELECT a.REFERENCE_NUMBER,a.CREATED_ON,a.TIMELINE_START_DATE,a.TIMELINE_END_DATE,
       a.OFFICER_ID,a.HOD_RM_ASSIGNED,a.HOF_ASSIGNED,a.USER_TASK_ID,a.COMPLAINT_ID,a.MS_PROCESS_ENDED_STATUS,
       CASE
           WHEN CURRENT_DATE > a.TIMELINE_END_DATE THEN 'YES'
           ELSE 'NO' END AS TASK_OVER_DUE
FROM DAT_KEBS_MS_WORKPLAN_GENARATED a;
...
SELECT a.REFERENCE_NUMBER,a.CREATED_ON,a.TIMELINE_START_DATE,a.TIMELINE_END_DATE,a.OFFICER_ID,a.HOD_RM_ASSIGNED,a.HOF_ASSIGNED,a.USER_TASK_ID,a.COMPLAINT_ID,
       a.FINAL_REPORT_GENERATED,a.INVEST_INSPECT_REPORT_STATUS,a.MS_PRELIMINARY_REPORT_STATUS,a.DATA_REPORT_STATUS,a.FIELD_REPORT_STATUS,a.MS_PROCESS_ID,a.MS_PROCESS_ENDED_STATUS,
       CASE
           WHEN CURRENT_DATE > a.TIMELINE_END_DATE THEN 'YES'
           ELSE 'NO' END AS TASK_OVER_DUE
FROM DAT_KEBS_MS_WORKPLAN_GENARATED a;
