...
SELECT b.ID,b.SENDERS_DATE,b.DATE_VISIT,b.SAMPLE_REFERENCES,c.RESULTS_DATE,c.RESULT_SENT_DATE,a.OFFICER_ID,a.COMPLAINT_DEPARTMENT,
       ...
       b.MARKET_CENTRE,b.NAME_ADDRESS_OUTLET,b.PRODUCT_DESCRIPTION,b.SECTOR,b.UCR_PERMIT_NO,b.SOURCE_PRODUCT_EVIDENCE,
        ...
        nvl(c.FAILED_PARAMETERS,'N/A') AS FAILED_PARAMETERS,
        nvl(f.FUNCTION,'N/A') AS SECTOR,
        nvl(f.MARKET_CENTER,'N/A') AS MARKET_CENTER,
        nvl(f.SOURCE_OF_PRODUCT_AND_EVIDENCE,'N/A') AS SOURCE_OF_PRODUCT_AND_EVIDENCE,
        nvl(f.OUTLET_DETAILS,'N/A') AS OUTLET_DETAILS,
        nvl(e.PERMIT_NUMBER,'N/A') AS PERMIT_NUMBER,
        nvl(e.UCR_NUMBER,'N/A') AS UCR_NUMBER,
...
JOIN DAT_KEBS_MS_DATA_REPORT_PARAMETERS e ON b.PRODUCT_IN_DATA_REPORT = e.ID
JOIN DAT_KEBS_MS_DATA_REPORT f ON b.DATA_REPORT_ID = f.ID
;
...
SELECT DISTINCT b.ID,b.INSPECTION_DATE,b.MARKET_CENTER,b.OUTLET_DETAILS,a.COMPLAINT_DEPARTMENT,a.OFFICER_ID,b.TOTAL_COMPLIANCE_SCORE,d.REPORT_DATE,
       ...
       (SELECT COUNT(*) FROM DAT_KEBS_MS_DATA_REPORT_PARAMETERS p WHERE p.DATA_REPORT_ID= b.ID) AS NO_OF_SAMPLES_PHYSICALLY_INSPECTED,
        ...
        CASE
            WHEN a.INVEST_INSPECT_REPORT_STATUS = 1 THEN TO_CHAR(ROUND((d.REPORT_DATE-b.INSPECTION_DATE)+1))
            ELSE 'NOT YET FILLED'  END AS TIME_TAKEN_FILE_SURVEILLANCE_REPORT,
        CASE
            WHEN a.INVEST_INSPECT_REPORT_STATUS = 1  AND ((ROUND((d.REPORT_DATE-b.INSPECTION_DATE)+1)) <= 1) THEN '1'
