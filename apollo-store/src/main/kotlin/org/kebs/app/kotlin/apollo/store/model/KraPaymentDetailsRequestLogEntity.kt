...
@Entity
@Table(name = "DAT_KEBS_LOG_KRA_PAYMENT_DETAIL_REQUEST")
class KraPaymentDetailsRequestLogEntity : Serializable {

    @Id
    @SequenceGenerator(name = "DAT_KEBS_LOG_KRA_PAYMENT_DETAIL_REQUEST_SEQ_GEN", allocationSize = 1, sequenceName = "DAT_KEBS_LOG_KRA_PAYMENT_DETAIL_REQUEST_SEQ")
    @GeneratedValue(generator = "DAT_KEBS_LOG_KRA_PAYMENT_DETAIL_REQUEST_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    ...
    @Column(name = "REQUEST_PAYMENT_SLIP_NUMBER")
    @Basic
    var requestPaymentSlipNo: String? = null
