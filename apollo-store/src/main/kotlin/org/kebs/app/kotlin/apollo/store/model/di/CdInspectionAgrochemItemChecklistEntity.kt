...
class CdInspectionAgrochemItemChecklistEntity : Serializable {
    ...
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CD_INSPECTION_AGROCHEM_ITEM_CHECKLIST_SEQ_GEN", sequenceName = "DAT_KEBS_CD_INSPECTION_AGROCHEM_ITEM_CHECKLIST_SEQ", allocationSize = 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CdInspectionAgrochemItemChecklistEntity
        return id == that.id &&
