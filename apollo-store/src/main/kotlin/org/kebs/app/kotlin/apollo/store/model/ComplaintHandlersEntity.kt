...
@Entity
@Table(name = "DAT_KEBS_MS_COMPLAINT_HANDLERS")
class ComplaintHandlersEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_MS_COMPLAINT_HANDLERS_SEQ_GEN", allocationSize = 1, sequenceName = "DAT_KEBS_MS_COMPLAINT_HANDLERS_SEQ")
    @GeneratedValue(generator = "DAT_KEBS_MS_COMPLAINT_HANDLERS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    @Column(name = "KEBS_SUPERVISOR")
    @Basic
    var kebsSupervisor: String? = null

    @Column(name = "SUPERVISOR_DESIGNATION")
    @Basic
    var supervisorDesignation: String? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ComplaintHandlersEntity
        return id == that.id &&
                kebsOfficer == that.kebsOfficer &&
                officerDesignation == that.officerDesignation &&
                kebsSupervisor == that.kebsSupervisor &&
                supervisorDesignation == that.supervisorDesignation &&
