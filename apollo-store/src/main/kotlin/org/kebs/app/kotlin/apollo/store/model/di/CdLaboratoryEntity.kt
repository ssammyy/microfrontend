...
class CdLaboratoryEntity: Serializable {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CdLaboratoryEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, labName, description, status, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
}