...
@Entity
@Table(name = "SD_NWA_STANDARD_UPLOADS")
class NWAStandardUploads : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(
        name = "SD_NWA_STANDARD_UPLOADS_SEQ_GEN",
        allocationSize = 1,
        sequenceName = "SD_NWA_STANDARD_UPLOADS_SEQ"
    )
    @GeneratedValue(generator = "SD_NWA_STANDARD_UPLOADS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long? = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as NWAStandardUploads
