...
class ConsignmentDocumentTypesEntity : Serializable {
    ...
    @Column(name = "DEMAND_NOTE_PREFIX")
    @Basic
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ConsignmentDocumentTypesEntity
        return id == that.id &&
                uuid == that.uuid &&
                demandNotePrefix == that.demandNotePrefix &&
                typeName == that.typeName &&
                description == that.description &&
                status == that.status &&
                localCocStatus == that.localCocStatus &&
                localCorStatus == that.localCorStatus &&
