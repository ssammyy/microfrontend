...
@Entity
@Table(name = "KEBS_MANUFACTURER_DEPARTMENTS")
class ManufacturerDepartmentsEntity : Serializable {
    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    @SequenceGenerator(name = "KEBS_MANUFACTURER_DEPARTMENTS_SEQ_GEN", sequenceName = "KEBS_MANUFACTURER_DEPARTMENTS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "KEBS_MANUFACTURER_DEPARTMENTS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long = 0

    @Column(name = "DEPARTMENT_CODE", nullable = true, length = 128)
    @Basic
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ManufacturerDepartmentsEntity
        return id == that.id &&
