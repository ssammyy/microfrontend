...
@Entity
@Table(name = "REF_KEBS_LOCATIONS")
class LocationsEntity : Serializable {
    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    var id: Long = 0

    @Column(name = "COUNTRY", nullable = true, length = 350)
    @Basic
    var country: String? = null

    @Column(name = "COUNTY", nullable = true, length = 350)
    @Basic
    var county: String? = null

    @Column(name = "SUB_COUNTY", nullable = true, length = 350)
    @Basic
    var subCounty: String? = null

    @Column(name = "KEBS_SUB_REGION", nullable = true, length = 500)
    @Basic
    var kebsSubRegion: String? = null

    @Column(name = "KEBS_REGION", nullable = true, length = 500)
    @Basic
    var kebsRegion: String? = null

    @Column(name = "TOWN", nullable = true, length = 350)
    @Basic
    var town: String? = null

    @Column(name = "MARKET", nullable = true, length = 350)
    @Basic
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as LocationsEntity
        return id == that.id &&
