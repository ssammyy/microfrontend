...
@Entity
@Table(name = "DAT_KEBS_MS_COMPLAINT_WITNESS")
class ComplaintWitnessEntity : Serializable {
    @SequenceGenerator(name = "DAT_KEBS_MS_COMPLAINT_WITNESS_SEQ_GEN", sequenceName = "DAT_KEBS_MS_COMPLAINT_WITNESS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_MS_COMPLAINT_WITNESS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Column(name = "ID")
    @Id
    var id: Long? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ComplaintWitnessEntity
        return id == that.id &&
