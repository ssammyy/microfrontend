...
class MsFuelInspectionOfficersEntity : Serializable{
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MsFuelInspectionOfficersEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, officer, designation, party, transactionDate, status, remarks, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, lastModifiedBy, lastModifiedOn, updateBy, updatedOn, deleteBy, deletedOn, version)
    }
