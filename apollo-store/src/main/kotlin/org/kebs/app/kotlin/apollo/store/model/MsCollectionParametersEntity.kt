...
class MsCollectionParametersEntity: Serializable {
    ...
    @JoinColumn(name = "SAMPLE_COLLECTION_ID", referencedColumnName = "ID")
    @ManyToOne
    var sampleCollectionId: MsSampleCollectionEntity? = null

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other == null || javaClass != other.javaClass) return false
        val that = other as MsCollectionParametersEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, productBrandName, batchNo, batchSize, sampleSize, description, status, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
