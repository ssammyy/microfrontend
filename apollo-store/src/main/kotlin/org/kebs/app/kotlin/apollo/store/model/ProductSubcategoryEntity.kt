...
@Entity
@Table(name = "CFG_PRODUCT_SUBCATEGORY")
class ProductSubcategoryEntity : Serializable {
    @Column(name = "ID")
    @Id
...
//    var productId: ProductsEntity? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ProductSubcategoryEntity
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, name, description, productId, status, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn, modifiedStatus)
    }
}