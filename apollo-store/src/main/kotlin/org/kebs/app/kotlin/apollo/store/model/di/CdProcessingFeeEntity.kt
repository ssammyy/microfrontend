...
@Entity
@Table(name = "DAT_KEBS_CD_PROCESSING_FEE")
class CdProcessingFeeEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CD_PROCESSING_FEE_SEQ_GEN", sequenceName = "DAT_KEBS_CD_PROCESSING_FEE_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_CD_PROCESSING_FEE_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CdProcessingFeeEntity
        return id == that.id &&
