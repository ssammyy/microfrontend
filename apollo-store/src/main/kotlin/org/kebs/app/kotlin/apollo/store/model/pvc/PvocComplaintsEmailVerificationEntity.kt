...
@Entity
@Table(name = "DAT_KEBS_PVOC_COMPLAINTS_EMAIL_VERIFICATION")
class PvocComplaintsEmailVerificationEntity : Serializable {
    @get:Column(name = "ID")
    @get:Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as PvocComplaintsEmailVerificationEntity
        return id == that.id &&
                status == that.status &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, status, enabled, email, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
}