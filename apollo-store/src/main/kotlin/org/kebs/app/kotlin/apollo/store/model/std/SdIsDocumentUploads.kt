...
@Entity
@Table(name = "SD_IS_DOCUMENTS_UPLOADS")
class SdIsDocumentUploads : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(
        name = "SD_IS_DOCUMENTS_UPLOADS_SEQ_GEN",
        allocationSize = 1,
        sequenceName = "SD_IS_DOCUMENTS_UPLOADS_SEQ"
    )
    @GeneratedValue(generator = "SD_IS_DOCUMENTS_UPLOADS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long? = 0
    ...
    @Column(name = "IS_DOCUMENT_ID")
    @Basic
    var isDocumentId: Long? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as SdIsDocumentUploads
