...
class CustomsOfficeTypeCodesEntity : Serializable {
    ...
    @Column(name = "CUSTOMS_OFFICE_NAME")
    @Basic
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CustomsOfficeTypeCodesEntity
        return id == that.id &&
                customsOfficeCode == that.customsOfficeCode &&
                customsOfficeName == that.customsOfficeName &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, customsOfficeCode, customsOfficeName, description, status, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
}