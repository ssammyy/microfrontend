...
@Entity
@Table(name = "DAT_PAYMENTS_LOG")
class PaymentsLogEntity : Serializable {
    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    var id: Long = 0

    @Column(name = "ESLIP_NUMBER", nullable = true, length = 528)
    @Basic
    var eslipNumber: String? = null

    @Column(name = "ESLIP_GENERATION_DATE", nullable = true)
    @Basic
    var eslipGenerationDate: Time? = null
    ...
    @Column(name = "COMMODITY", nullable = true, length = 528)
    @Basic
    ...
    @Column(name = "SKU", nullable = true, length = 700)
    @Basic
    var sku: String? = null

    @Column(name = "TOTAL_VALUE", nullable = true, precision = 3)
    @Basic
    var totalValue: Long? = null

    @Column(name = "LEVY_PAYABLE", nullable = true, precision = 3)
    @Basic
    var levyPayable: Long? = null

    @Column(name = "PAYMENT_DATE", nullable = true)
    @Basic
    var paymentDate: Time? = null

    @Column(name = "BANK", nullable = true, length = 528)
    @Basic
    var bank: String? = null

    @Column(name = "BANK_CODE", nullable = true, length = 528)
    @Basic
    var bankCode: String? = null

    @Column(name = "BANK_REFERENCE_NUMBER", nullable = true, length = 528)
    @Basic
    ...
    @ManyToOne
    var paymentTypeId: PaymentTypesEntity? = null

    @JoinColumn(name = "PAYMENT_MODE", referencedColumnName = "ID")
    @ManyToOne
    var paymentModeId: PaymentModeEntity? = null

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other == null || javaClass != other.javaClass) return false
        val that = other as PaymentsLogEntity
        return id == that.id &&
                eslipNumber == that.eslipNumber &&
                eslipGenerationDate == that.eslipGenerationDate &&
                ...
                bankReferenceNumber == that.bankReferenceNumber &&
                status == that.status &&
