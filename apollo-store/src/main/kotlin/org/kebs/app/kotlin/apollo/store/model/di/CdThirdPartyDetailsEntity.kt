...
@Entity
@Table(name = "DAT_KEBS_CD_THIRD_PARTY_DETAILS")
class CdThirdPartyDetailsEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CD_THIRD_PARTY_DETAILS_SEQ_GEN", sequenceName = "DAT_KEBS_CD_THIRD_PARTY_DETAILS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_CD_THIRD_PARTY_DETAILS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CdThirdPartyDetailsEntity
        return id == that.id &&
