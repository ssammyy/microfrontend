...
@Entity
@Table(name = "DAT_KEBS_PVOC_QUERIES_DATA")
class PvocQueriesDataEntity : Serializable {
    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    @SequenceGenerator(name = "DAT_KEBS_PVOC_QUERIES_DATA_SEQ_GEN", sequenceName = "DAT_KEBS_PVOC_QUERIES_DATA_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_PVOC_QUERIES_DATA_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as PvocQueriesDataEntity
        return id == that.id &&
