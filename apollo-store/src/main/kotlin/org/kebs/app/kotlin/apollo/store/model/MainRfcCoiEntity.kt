...
@Entity
@Table(name = "DAT_KEBS_MAIN_RFC_COI")
class MainRfcCoiEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_MAIN_RFC_COI_SEQ_GEN", allocationSize = 1, sequenceName = "DAT_KEBS_MAIN_RFC_COI_SEQ")
    @GeneratedValue(generator = "DAT_KEBS_MAIN_RFC_COI_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    @Column(name = "ITEM_COMPLETE_STATUS")
    @Basic
    var itemCompleteStatus: Int? = 0
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, itemCompleteStatus, countryOfDestination, applicationType, idfNumber, ucrNumber, routeUsed, importerName, importerPin, importerAddress1, importerAddress2, importerCity, importerCountry, importerZipCode, importerTelephoneNumber, importerFaxNumber, importerEmail, exporterName, exporterPin, exporterAddress1, exporterAddress2, exporterCity, exporterCountry, exporterZipCode, exporterTelephoneNumber, exporterFaxNumber, exporterEmail, placeOfInspectionName, placeOfInspectionAddress, placeOfInspectionEmail, placeOfInspectionContacts, shippingMethod, portOfLoading, portOfDischarge, countryOfSupply, goodsCondition, assemblyState, listOfDocumentsAttached, partner, status, descriptions, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, lastModifiedBy, lastModifiedOn, updateBy, updatedOn, deleteBy, deletedOn, version)
    }
}