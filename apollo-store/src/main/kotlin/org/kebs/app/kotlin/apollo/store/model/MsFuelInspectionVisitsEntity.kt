...
@Entity
@Table(name = "DAT_KEBS_MS_FUEL_INSPECTION_VISITS")
class MsFuelInspectionVisitsEntity {
    @get:Column(name = "ID")
    @get:Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MsFuelInspectionVisitsEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, company, kebsOfficer, location, visitDate, transactionDate, status, remarks, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, lastModifiedBy, lastModifiedOn, updateBy, updatedOn, deleteBy, deletedOn, version)
    }
