...
@Entity
@Table(name = "CFG_BATCH_JOB_TYPES")
@DynamicUpdate
class BatchJobTypes : Serializable {
    @Column(name = "ID")
    @Id
    @SequenceGenerator(name = "CFG_BATCH_JOB_TYPES_SEQ_GEN", sequenceName = "CFG_BATCH_JOB_TYPES_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "CFG_BATCH_JOB_TYPES_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long? = null
