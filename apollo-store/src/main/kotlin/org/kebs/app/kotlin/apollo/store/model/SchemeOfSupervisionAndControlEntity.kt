...
@Entity
@Table(name = "DAT_SCHEME_OF_SUPERVISION_AND_CONTROL")
class SchemeOfSupervisionAndControlEntity: Serializable {
    @Column(name = "ID")
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as SchemeOfSupervisionAndControlEntity
        return id == that.id &&
                status == that.status &&
