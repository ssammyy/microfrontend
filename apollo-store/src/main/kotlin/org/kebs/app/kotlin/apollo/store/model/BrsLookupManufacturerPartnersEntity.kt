...
@Entity
@Table(name = "LOG_BRS_LOOKUP_MANUFACTURER_PARTNERS")
class BrsLookupManufacturerPartnersEntity : Serializable {
    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    @SequenceGenerator(name = "LOG_BRS_LOOKUP_MANUFACTURER_PARTNERS_SEQ_GEN", sequenceName = "LOG_BRS_LOOKUP_MANUFACTURER_PARTNERS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "LOG_BRS_LOOKUP_MANUFACTURER_PARTNERS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long = 0
    ...
    @Column(name = "NAMES", nullable = true, length = 350)
    @Basic
    ...
    @Column(name = "ID_NUMBER", nullable = true, length = 350)
    @Basic
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as BrsLookupManufacturerPartnersEntity
        return id == that.id &&
