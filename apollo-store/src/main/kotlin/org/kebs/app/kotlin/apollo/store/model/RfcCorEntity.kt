...
@Entity
@Table(name = "DAT_KEBS_RFC_COR")
class RfcCorEntity : Serializable {

    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    @SequenceGenerator(name = "DAT_KEBS_RFC_COR_SEQ_GEN", sequenceName = "DAT_KEBS_RFC_COR_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_RFC_COR_SEQ_GEN", strategy = GenerationType.SEQUENCE)
