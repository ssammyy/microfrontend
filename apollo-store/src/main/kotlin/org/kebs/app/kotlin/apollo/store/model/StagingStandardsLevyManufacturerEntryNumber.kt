...
@Entity
@Table(name = "STG_STANDARDS_LEVY_MANUFACTURER_ENTRY_NUMBER")
@DynamicUpdate
class StagingStandardsLevyManufacturerEntryNumber : Serializable {
    @Column(name = "ID")
    @Id
    @SequenceGenerator(name = "STG_STANDARDS_LEVY_MANUFACTURER_ENTRY_NUMBER_SEQ_GEN", sequenceName = "STG_STANDARDS_LEVY_MANUFACTURER_ENTRY_NUMBER_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "STG_STANDARDS_LEVY_MANUFACTURER_ENTRY_NUMBER_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StagingStandardsLevyManufacturerEntryNumber
