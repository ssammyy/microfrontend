...
@Entity
@Table(name = "DAT_KEBS_PVOC_EXCEPTION_MAIN_MACHINERY_CATEGORY")
class PvocExceptionMainMachineryCategoryEntity : Serializable {
    @Column(name = "ID")
    @Id
    @SequenceGenerator(name = "DAT_KEBS_PVOC_EXCEPTION_MAIN_MACHINERY_CATEGORY_SEQ_GEN", sequenceName = "DAT_KEBS_PVOC_EXCEPTION_MAIN_MACHINERY_CATEGORY_SEQ", allocationSize = 1)
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val that = o as PvocExceptionMainMachineryCategoryEntity
        return id == that.id &&
                status == that.status &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, status, machineDescription, checkBoxChecked, countryOfOrigin, makeModel, remarks, hsCode, dutyRate, exceptionId, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn, reviewStatus)
    }
}