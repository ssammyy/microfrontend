...
@Entity
@Table(name = "DAT_KEBS_MS_WORK_PLAN_USERS")
class WorkPlanUsersEntity : Serializable {
    @Column(name = "ID")
    @Id
    @SequenceGenerator(name = "DAT_KEBS_MS_WORK_PLAN_USERS_SEQ_GEN", sequenceName = "DAT_KEBS_MS_WORK_PLAN_USERS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_MS_WORK_PLAN_USERS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as WorkPlanUsersEntity
        return id == that.id &&
