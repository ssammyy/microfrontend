...
@Entity
@Table(name = "DAT_KEBS_CD_EXPORTER_DETAILS")
class CdExporterDetailsEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CD_EXPORTER_DETAILS_SEQ_GEN", sequenceName = "DAT_KEBS_CD_EXPORTER_DETAILS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_CD_EXPORTER_DETAILS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CdExporterDetailsEntity
        return id == that.id &&
                name == that.name &&
                pin == that.pin &&
