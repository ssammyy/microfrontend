...
class PvocPartnersEntity : Serializable {
    ...
    @Column(name = "PARTNER_REF_NO", nullable = false, length = 250)
    @Basic
    ...
    @Column(name = "INTEGRATION_USERNAME", nullable = true, length = 1000)
    @Basic
    var integrationUsername: String? = null

    @Column(name = "INTEGRATION_PASSWORD", nullable = true, length = 150)
    @Basic
    var integrationPassword: String? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return id == that.id &&
                ...
                integrationUsername == that.integrationUsername &&
                integrationPassword == that.integrationPassword &&
                status == that.status &&
