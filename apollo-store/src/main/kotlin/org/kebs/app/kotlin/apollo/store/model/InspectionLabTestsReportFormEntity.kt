...
class InspectionLabTestsReportFormEntity : Serializable {
    @Column(name = "ID")
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as InspectionLabTestsReportFormEntity
        if (id != that.id) return false
        if (if (parameters != null) parameters != that.parameters else that.parameters != null) return false
        if (if (results != null) results != that.results else that.results != null) return false
        if (if (requirements != null) requirements != that.requirements else that.requirements != null) return false
        if (if (testMethodNo != null) testMethodNo != that.testMethodNo else that.testMethodNo != null) return false
        if (if (lod != null) lod != that.lod else that.lod != null) return false
        if (if (testDate != null) testDate != that.testDate else that.testDate != null) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + if (results != null) results.hashCode() else 0
        result = 31 * result + if (requirements != null) requirements.hashCode() else 0
        result = 31 * result + if (testMethodNo != null) testMethodNo.hashCode() else 0
        result = 31 * result + if (lod != null) lod.hashCode() else 0
        result = 31 * result + if (testDate != null) testDate.hashCode() else 0
