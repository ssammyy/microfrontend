...
@Entity
@Table(name = "DAT_KEBS_RISK_PROFILE_CONSIGNEE")
class RiskProfileConsigneeEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_RISK_PROFILE_CONSIGNEE_SEQ_GEN", sequenceName = "DAT_KEBS_RISK_PROFILE_CONSIGNEE_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_RISK_PROFILE_CONSIGNEE_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RiskProfileConsigneeEntity
        return id == that.id &&
                name == that.name &&
                pin == that.pin &&
