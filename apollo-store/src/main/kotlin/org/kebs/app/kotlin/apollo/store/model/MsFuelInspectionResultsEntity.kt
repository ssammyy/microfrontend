...
@Entity
@Table(name = "DAT_KEBS_MS_FUEL_INSPECTION_RESULTS")
class MsFuelInspectionResultsEntity {
    @get:Column(name = "ID")
    @get:Id
    var id: Long = 0

    @get:Column(name = "RESULTS_DATE")
    @get:Basic
    var resultsDate: Time? = null

    @get:Column(name = "RESULTS")
    @get:Basic
    var results: String? = null

    @get:Column(name = "RECOMMENDATION")
    @get:Basic
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MsFuelInspectionResultsEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, resultsDate, results, recommendation, transactionDate, status, remarks, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, lastModifiedBy, lastModifiedOn, updateBy, updatedOn, deleteBy, deletedOn, version)
    }
