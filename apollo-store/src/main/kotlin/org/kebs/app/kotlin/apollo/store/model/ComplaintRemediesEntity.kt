...
@Entity
@Table(name = "DAT_KEBS_MS_COMPLAINT_REMEDIES")
class ComplaintRemediesEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_MS_COMPLAINT_REMEDIES_SEQ_GEN", sequenceName = "DAT_KEBS_MS_COMPLAINT_REMEDIES_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_MS_COMPLAINT_REMEDIES_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ComplaintRemediesEntity
        return id == that.id &&
