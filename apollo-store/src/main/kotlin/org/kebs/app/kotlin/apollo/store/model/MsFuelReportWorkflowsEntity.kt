...
@Entity
@Table(name = "DAT_KEBS_MS_FUEL_REPORT_WORKFLOWS")
class MsFuelReportWorkflowsEntity {
    @get:Column(name = "ID")
    @get:Id
    var id: Long = 0

    @get:Column(name = "REPORT")
    @get:Basic
    ...
    @get:Column(name = "PREPARATION_DATE")
    @get:Basic
    var preparationDate: Timestamp? = null

    @get:Column(name = "SUBMISSION_DATE")
    @get:Basic
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as MsFuelReportWorkflowsEntity
        return id == that.id &&
                report == that.report &&
                kebsOfficer == that.kebsOfficer &&
                officerDesignation == that.officerDesignation &&
                preparationDate == that.preparationDate &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, report, kebsOfficer, officerDesignation, preparationDate, submissionDate, transactionDate, status, remarks, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, lastModifiedBy, lastModifiedOn, updateBy, updatedOn, deleteBy, deletedOn, version)
    }
