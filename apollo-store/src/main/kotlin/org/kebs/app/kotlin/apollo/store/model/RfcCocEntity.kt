...
@Entity
@Table(name = "DAT_KEBS_RFC_COC")
class RfcCocEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_RFC_COC_SEQ_GEN", allocationSize = 1, sequenceName = "DAT_KEBS_RFC_COC_SEQ")
    @GeneratedValue(generator = "DAT_KEBS_RFC_COC_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RfcCocEntity
        return id == that.id &&
