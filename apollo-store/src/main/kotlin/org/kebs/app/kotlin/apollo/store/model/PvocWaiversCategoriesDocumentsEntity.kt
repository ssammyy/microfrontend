...
@Entity
@Table(name = "DAT_KEBS_PVOC_WAIVERS_CATEGORIES_DOCUMENTS")
class PvocWaiversCategoriesDocumentsEntity : Serializable {
    @get:Column(name = "ID")
    @get:Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as PvocWaiversCategoriesDocumentsEntity
        return id == that.id &&
                status == that.status &&
                name == that.name &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, status, name, description, categoryId, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
