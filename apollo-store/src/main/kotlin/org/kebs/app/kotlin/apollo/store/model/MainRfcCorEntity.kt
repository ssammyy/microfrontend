...
@Entity
@Table(name = "DAT_KEBS_MAIN_RFC_COR")
class MainRfcCorEntity : Serializable{
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_MAIN_RFC_COR_SEQ_GEN", allocationSize = 1, sequenceName = "DAT_KEBS_MAIN_RFC_COR_SEQ")
    @GeneratedValue(generator = "DAT_KEBS_MAIN_RFC_COR_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    @Basic
    var rfcDate: Time? = null

    @Column(name = "PREFERRED_DATE_OF_INSPECTION")
    @Basic
    var preferredDateOfInspection: Time? = null
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val that = o as MainRfcCorEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, countryOfDestination, applicationType, idfNumber, ucrNumber, routeUsed, sorSolRef, importerName, importerPin, importerAddress1, importerAddress2, importerCity, importerCountry, importerZipCode, importerTelephoneNumber, importerFaxNumber, importerEmail, exporterName, exporterPin, exporterAddress1, exporterAddress2, exporterCity, exporterCountry, exporterZipCode, exporterTelephoneNumber, exporterFaxNumber, exporterEmail, applicantName, applicantPin, applicantAddress1, applicantAddress2, applicantCity, applicantCountry, applicantZipCode, applicantTelephoneNumber, applicantFaxNumber, applicantEmail, placeOfInspection, placeOfInspectionAddress, placeOfInspectionEmail, placeOfInspectionContacts, shippingMethod, portOfLoading, portOfDischarge, countryOfSupply, goodsCondition, assemblyState, listOfDocumentsAttached, rfcDate, preferredDateOfInspection, make, model, chassisNumber, engineNumber, engineCapacity, yearOfManufacture, yearOfFirstRegistration, partner, status, descriptions, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, lastModifiedBy, lastModifiedOn, updateBy, updatedOn, deleteBy, deletedOn, version)
    }
}