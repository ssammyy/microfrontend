...
@Entity
@Table(name = "CFG_APPROVAL_STATUS")
class ApprovalStatusEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "CFG_APPROVAL_STATUS_SEQ_GEN", allocationSize = 1, sequenceName = "CFG_APPROVAL_STATUS_SEQ")
    @GeneratedValue(generator = "CFG_APPROVAL_STATUS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Int? = null
