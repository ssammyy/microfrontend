...
@Entity
@Table(name = "DAT_KEBS_MS_WORK_PLAN_APPROVALS")
class WorkPlanApprovalsEntity : Serializable {
    @Column(name = "ID")
    @Id
    @SequenceGenerator(name = "DAT_KEBS_MS_WORK_PLAN_APPROVALS_SEQ_GEN", sequenceName = "DAT_KEBS_MS_WORK_PLAN_APPROVALS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_MS_WORK_PLAN_APPROVALS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long = 0

    @Column(name = "WORK_PLAN_STAGE")
    @Basic
    var isWorkPlanStage = false
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as WorkPlanApprovalsEntity
        return id == that.id && isWorkPlanStage == that.isWorkPlanStage &&
