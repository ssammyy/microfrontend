...
@Entity
@Table(name = "DAT_KEBS_RFC_COI_ITEMS")
class RfcCoiItemsEntity : Serializable {
    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    @SequenceGenerator(name = "DAT_KEBS_RFC_COI_ITEMS_SEQ_GEN", sequenceName = "DAT_KEBS_RFC_COI_ITEMS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_RFC_COI_ITEMS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as RfcCoiItemsEntity
        return id == that.id &&
                rfcId == that.rfcId &&
