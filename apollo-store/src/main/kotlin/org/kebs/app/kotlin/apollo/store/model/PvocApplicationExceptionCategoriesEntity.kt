...
@Entity
@Table(name = "DAT_KEBS_PVOC_APPLICATION_EXCEPTION_CATEGORIES")
class PvocApplicationExceptionCategoriesEntity: Serializable {
    @get:Column(name = "ID")
    @get:Id
    var id: Long = 0
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val that = o as PvocApplicationExceptionCategoriesEntity
        return id == that.id &&
                status == that.status &&
                name == that.name &&
