...
@Entity
@Table(name = "LOG_KRA_ENTRY_NUMBER_REQUEST", schema = "APOLLO", catalog = "")
class LogKraEntryNumberRequestEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "LOG_KRA_ENTRY_NUMBER_REQUEST_SEQ_GEN", allocationSize = 1, sequenceName = "LOG_KRA_ENTRY_NUMBER_REQUEST_SEQ")
    @GeneratedValue(generator = "LOG_KRA_ENTRY_NUMBER_REQUEST_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long? = 0
