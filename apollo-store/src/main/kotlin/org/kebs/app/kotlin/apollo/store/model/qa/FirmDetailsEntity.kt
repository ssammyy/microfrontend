...
@Entity
@Table(name ="DAT_KEBS_FIRM_DETAILS")
class FirmDetailsEntity :Serializable{
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_FIRM_DETAILS_SEQ_GEN", allocationSize = 1, sequenceName = "DAT_KEBS_FIRM_DETAILS_SEQ")
    @GeneratedValue(generator = "DAT_KEBS_FIRM_DETAILS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long? = 0

//    @Embedded
//    var addressEmbeddable: AddressEmbeddable? = null
