...
//    @Column(name = "ID")
//    @Id
//    @SequenceGenerator(name = "STG_PAYMENT_RECONCILIATION_SEQ_GEN", allocationSize = 1, sequenceName = "STG_PAYMENT_RECONCILIATION_SEQ")
...
//    @Basic
//    var paymentTransactionDate: Date? = null
//
