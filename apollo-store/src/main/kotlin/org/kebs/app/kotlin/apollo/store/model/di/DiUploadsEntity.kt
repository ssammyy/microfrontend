...
@Entity
@Table(name = "DAT_KEBS_DI_UPLOADS")
class DiUploadsEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_DI_UPLOADS_SEQ_GEN", sequenceName = "DAT_KEBS_DI_UPLOADS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_DI_UPLOADS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    @ManyToOne
    var cdId: ConsignmentDocumentDetailsEntity? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as DiUploadsEntity
        return id == that.id &&
