...
@Entity
@Table(name = "DAT_KEBS_CD_CONSIGNOR_DETAILS")
class CdConsignorDetailsEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CD_CONSIGNOR_DETAILS_SEQ_GEN", sequenceName = "DAT_KEBS_CD_CONSIGNOR_DETAILS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_CD_CONSIGNOR_DETAILS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CdConsignorDetailsEntity
        return id == that.id &&
                name == that.name &&
                pin == that.pin &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, name, pin,mdaRefNo, postalAddress,  postalCountryName, physicalCountryName,  physicalAddress, telephone, applicationCode, postalCountry, physicalCountry, email, ogaRefNo, fax, sectorOfActivity, warehouseLocation, dateSubmitted, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, lastModifiedBy, lastModifiedOn, updateBy, updatedOn, deleteBy, deletedOn, version, warehouseCode)
    }
}