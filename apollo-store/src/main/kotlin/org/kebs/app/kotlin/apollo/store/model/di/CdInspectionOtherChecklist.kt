...
@Entity
@Table(name = "DAT_KEBS_CD_INSPECTION_OTHER_CHECKLIST")
class CdInspectionOtherChecklist : Serializable {

    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CD_INSPECTION_OTHER_CHECKLIST_SEQ_GEN", sequenceName = "DAT_KEBS_CD_INSPECTION_OTHER_CHECKLIST_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_CD_INSPECTION_OTHER_CHECKLIST_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CdInspectionOtherChecklist
        return id == that.id &&
