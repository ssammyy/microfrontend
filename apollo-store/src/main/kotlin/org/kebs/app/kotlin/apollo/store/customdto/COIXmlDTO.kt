...
class CoiDetails(shipmentLineNumber: Long, shipmentLineHscode: String, shipmentLineQuantity: BigDecimal, shipmentLineUnitofMeasure: String,
    ...
    var shipmentLineQuantity: String? = shipmentLineQuantity.toString()
