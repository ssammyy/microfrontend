...
class QaBatchInvoiceEntity  : Serializable {
    @Column(name = "ID")
    @Id
    @SequenceGenerator(name = "DAT_KEBS_QA_BATCH_INVOICE_SEQ_GEN", sequenceName = "DAT_KEBS_QA_BATCH_INVOICE_SEQ", allocationSize = 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return id == that.id && totalAmount == that.totalAmount && invoiceNumber == that.invoiceNumber && description == that.description && status == that.status && varField1 == that.varField1 && varField2 == that.varField2 && varField3 == that.varField3 && varField4 == that.varField4 && varField5 == that.varField5 && varField6 == that.varField6 && varField7 == that.varField7 && varField8 == that.varField8 && varField9 == that.varField9 && varField10 == that.varField10 && createdBy == that.createdBy && createdOn == that.createdOn && modifiedBy == that.modifiedBy && modifiedOn == that.modifiedOn && deleteBy == that.deleteBy && deletedOn == that.deletedOn
    }
