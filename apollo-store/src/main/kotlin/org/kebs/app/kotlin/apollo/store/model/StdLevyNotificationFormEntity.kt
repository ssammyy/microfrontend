...
@Entity
@Table(name = "DAT_KEBS_STD_LEVY_NOTIFICATION_FORM")
class StdLevyNotificationFormEntity : Serializable{
    @Column(name = "ID")
    @Id
    @SequenceGenerator(name = "DAT_KEBS_STD_LEVY_NOTIFICATION_FORM_SEQ_GEN", sequenceName = "DAT_KEBS_STD_LEVY_NOTIFICATION_FORM_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_STD_LEVY_NOTIFICATION_FORM_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long? = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as StdLevyNotificationFormEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, nameBusinessProprietor, manufacturerId, commoditiesManufactured, chiefExecutiveDirectors, chiefExecutiveDirectorsStatus, dateManufactureCommenced, totalValueOfManufacture, description, status, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
}