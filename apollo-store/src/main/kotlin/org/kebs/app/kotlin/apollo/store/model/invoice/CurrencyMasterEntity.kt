...
class CurrencyMasterEntity : Serializable {
    ...
    @Basic
    var startDate: Time? = null

    @Column(name = "EXPIRY_DATE")
    @Basic
    var expiryDate: Time? = null
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CurrencyMasterEntity
        return id == that.id &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, typeName, rate, startDate, expiryDate, description, status, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
}