...
@Entity
@Table(name = "DAT_KEBS_CD_APPLICATION_STATUS")
class CdApplicationStatusEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CD_APPLICATION_STATUS_SEQ_GEN", sequenceName = "DAT_KEBS_CD_APPLICATION_STATUS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_CD_APPLICATION_STATUS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    @Basic
    var amendedDate: Date? = null

    @Column(name = "APPLICATION_DATE")
    @Basic
    var applicationDate: Date? = null

    @Column(name = "USED_DATED")
    @Basic
    var usedDated: Date? = null
