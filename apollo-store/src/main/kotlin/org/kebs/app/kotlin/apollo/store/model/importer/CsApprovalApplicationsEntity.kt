...
@Entity
@Table(name = "DAT_KEBS_CS_APPROVAL_APPLICATIONS")
class CsApprovalApplicationsEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_CS_APPROVAL_APPLICATIONS_SEQ_GEN", sequenceName = "DAT_KEBS_CS_APPROVAL_APPLICATIONS_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "DAT_KEBS_CS_APPROVAL_APPLICATIONS_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as CsApprovalApplicationsEntity
        return id == that.id &&
                cdId == that.cdId &&
                uuid == that.uuid &&
    ...
    override fun hashCode(): Int {
        return Objects.hash(id, uuid, confirmAssignedUserId, cdId, refNumber,assignedUserRemarks, assignedUserDate, assignedUserStatus, rejectedDate, rejectedRemarks, rejectedStatus, approvalDate, approvalRemarks, approvalStatus, sentMdDate, sentMdRemarks, sentMdStatus,  entryNumber, this.confirmEntryPoint, billOfLandingAirwayBill, productDescription, idfNo, ucrNo, transactionDate, description, status, varField1, varField2, varField3, varField4, varField5, varField6, varField7, varField8, varField9, varField10, createdBy, createdOn, modifiedBy, modifiedOn, deleteBy, deletedOn)
    }
}