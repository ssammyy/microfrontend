...
interface StandardRequestRepository:JpaRepository<StandardRequest, Long> {
    ...
    @Query(
        value = "SELECT * FROM SD_STANDARD_REQUEST  WHERE LEVEL_OF_STANDARD='International Standard' AND STATUS='Prepare Adoption Proposal' ORDER BY ID DESC",nativeQuery = true)
