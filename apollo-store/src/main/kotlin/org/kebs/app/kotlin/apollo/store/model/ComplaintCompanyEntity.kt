...
@Entity
@Table(name = "DAT_KEBS_MS_COMPLAINT_COMPANY")
class ComplaintCompanyEntity : Serializable {
    @Column(name = "ID")
    @SequenceGenerator(name = "DAT_KEBS_MS_COMPLAINT_COMPANY_SEQ_GEN", allocationSize = 1, sequenceName = "DAT_KEBS_MS_COMPLAINT_COMPANY_SEQ_GEN")
    @GeneratedValue(generator = "DAT_KEBS_MS_COMPLAINT_COMPANY_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as ComplaintCompanyEntity
        return id == that.id &&
                nameOfOutlet == that.nameOfOutlet &&
                businessAddress == that.businessAddress &&
                telephoneNumber == that.telephoneNumber &&
                mobilePhoneNumber == that.mobilePhoneNumber &&
