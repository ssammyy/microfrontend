...
@Entity
@Table(name = "LOG_BRS_LOOKUP_MANUFACTURER_DATA")
class BrsLookupManufacturerDataEntity : Serializable {
    @Column(name = "ID", nullable = false, precision = 0)
    @Id
    @SequenceGenerator(name = "LOG_BRS_LOOKUP_MANUFACTURER_DATA_SEQ_GEN", sequenceName = "LOG_BRS_LOOKUP_MANUFACTURER_DATA_SEQ", allocationSize = 1)
    @GeneratedValue(generator = "LOG_BRS_LOOKUP_MANUFACTURER_DATA_SEQ_GEN", strategy = GenerationType.SEQUENCE)
    var id: Long = 0
    ...
    @Column(name = "REGISTRATION_NUMBER", nullable = true, length = 350)
    @Basic
    ...
    @Column(name = "POSTAL_ADDRESS", nullable = true, length = 350)
    @Basic
    var postalAddress: String? = null

    @Column(name = "PHYSICAL_ADDRESS", nullable = true, length = 3000)
    @Basic
    ...
    @Column(name = "BRS_ID", nullable = true, length = 350)
    @Basic
    var brsId: String? = null

    @Column(name = "EMAIL", nullable = true, length = 350)
    @Basic
    var email: String? = null

    @Column(name = "KRA_PIN", nullable = true, length = 350)
    @Basic
    var kraPin: String? = null

    @Column(name = "BUSINESS_NAME", nullable = true, length = 350)
    @Basic
    ...
    @Column(name = "BRS_STATUS", nullable = true, precision = 0)
    @Basic
    var brsStatus: String? = null
    ...
    var brsLookupManufacturerPartners: Collection<BrsLookupManufacturerPartnersEntity>? = null

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other == null || javaClass != other.javaClass) return false
        val that = other as BrsLookupManufacturerDataEntity
        return id == that.id &&
