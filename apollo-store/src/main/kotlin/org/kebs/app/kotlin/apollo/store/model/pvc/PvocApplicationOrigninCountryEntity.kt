...
@Entity
@Table(name = "DAT_KEBS_PVOC_APPLICATION_ORIGNIN_COUNTRY")
class PvocApplicationOrigninCountryEntity: Serializable {
    @get:Column(name = "ID")
    @get:Id
    var id: Long = 0
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val that = o as PvocApplicationOrigninCountryEntity
        return id == that.id &&
                status == that.status &&
                name == that.name &&
