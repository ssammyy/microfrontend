...
@Entity
@Table(name = "DAT_KEBS_INSPECTION_OPERATIONS_PROCESS_CONTROL_FORM")
class InspectionOperationsProcessControlFormEntity : Serializable {
    @Column(name = "ID")
    @Id
    var id: Long = 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        val that = other as InspectionOperationsProcessControlFormEntity
        if (id != that.id) return false
        if (if (sNo != null) sNo != that.sNo else that.sNo != null) return false
        if (if (processFlow != null) processFlow != that.processFlow else that.processFlow != null) return false
        if (if (operations != null) operations != that.operations else that.operations != null) return false
        if (if (qualityChecks != null) qualityChecks != that.qualityChecks else that.qualityChecks != null) return false
        if (if (frequency != null) frequency != that.frequency else that.frequency != null) return false
        if (if (records != null) records != that.records else that.records != null) return false
        if (if (findings != null) findings != that.findings else that.findings != null) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + if (processFlow != null) processFlow.hashCode() else 0
        result = 31 * result + if (operations != null) operations.hashCode() else 0
        result = 31 * result + if (qualityChecks != null) qualityChecks.hashCode() else 0
        result = 31 * result + if (frequency != null) frequency.hashCode() else 0
        result = 31 * result + if (records != null) records.hashCode() else 0
        result = 31 * result + if (findings != null) findings.hashCode() else 0
