...
data class InspectionInvestigationReportJSPDto(
...
data class SampleSubmissionJSPDto(
        var id: String?= null,
        var nameProduct: String? = null,
        var packaging: String? = null,
        var labellingIdentification: String? = null,
...
data class SSFSaveFinalComplianceStatusDto(
        @NotNull(message = "Required field")
        var ssfID: Long,
        @NotNull(message = "Required field")
        var bsNumber: String,
