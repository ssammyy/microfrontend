...
class TechnicalCommittee {
    ...
    @OneToMany
    @JoinColumn(name="TECHNICAL_COMMITTEE_ID")
    ...
    override fun toString(): String {
        return "TechnicalCommittee(id=$id, technical_committee_no=$technical_committee_no, type=$type, tc=$tc, sc=$sc, wg=$wg, parentCommitte=$parentCommitte, title=$title, status=$status, comment=$comment, standardRequest=$standardRequest)"
    }
