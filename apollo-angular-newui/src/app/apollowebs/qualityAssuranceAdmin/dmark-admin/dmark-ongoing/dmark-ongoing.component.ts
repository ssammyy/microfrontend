...
@Component({
  selector: 'app-dmark-ongoing',
  templateUrl: './dmark-ongoing.component.html',
  styleUrls: ['./dmark-ongoing.component.css']
})
export class DmarkOngoingComponent implements OnInit {
  ...
  public getMySmarkOngoing(): void {
    ...
    this.internalService.loadMyOngoingByPermitType(this.dmarkID).subscribe(
