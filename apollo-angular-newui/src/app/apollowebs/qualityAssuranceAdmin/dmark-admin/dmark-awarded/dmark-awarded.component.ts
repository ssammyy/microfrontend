...
@Component({
  selector: 'app-dmark-awarded',
  templateUrl: './dmark-awarded.component.html',
  styleUrls: ['./dmark-awarded.component.css']
})
export class DmarkAwardedComponent implements OnInit {
  ...
  public getMySmarkComplete(): void {
    ...
    this.internalService.loadMyCompleteByPermitType(this.dmarkID).subscribe(
