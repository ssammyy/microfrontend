...
@Component({
  selector: 'app-dmark-all-applications',
  templateUrl: './dmark-all-applications.component.html',
  styleUrls: ['./dmark-all-applications.component.css']
})
export class DmarkAllApplicationsComponent implements OnInit {
  ...
  public getMySmarkComplete(): void {
    ...
    this.internalService.loadMyAllPermitByPermitType(this.dmarkID).subscribe(
