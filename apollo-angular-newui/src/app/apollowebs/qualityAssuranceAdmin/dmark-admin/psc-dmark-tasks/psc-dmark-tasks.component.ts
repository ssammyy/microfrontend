...
@Component({
  selector: 'app-psc-dmark-tasks',
  templateUrl: './psc-dmark-tasks.component.html',
  styleUrls: ['./psc-dmark-tasks.component.css']
})
export class PscDmarkTasksComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getMyPscDmarkTasks();
  }

  public getMyPscDmarkTasks(): void {
    this.loading = true
