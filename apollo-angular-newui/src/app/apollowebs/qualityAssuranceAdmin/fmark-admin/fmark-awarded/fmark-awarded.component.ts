...
@Component({
  selector: 'app-fmark-awarded',
  templateUrl: './fmark-awarded.component.html',
  styleUrls: ['./fmark-awarded.component.css']
})
export class FmarkAwardedComponent implements OnInit {
  ...
  public getMySmarkComplete(): void {
    ...
    this.internalService.loadMyCompleteByPermitType(this.fmarkID).subscribe(
