...
import {AcknowledgementDto, ApiResponseModel, SampleSubmittedDto} from '../../../../core/store/data/ms/ms.model';
...
export class SampleSubmittedTimelineComponent implements OnInit {
  ...
  selectedNotification: SampleSubmittedDto;
  loadedData!: SampleSubmittedDto[];
  totalCount = 12;
  public settings = {
  ...
  private loadData(page: number, records: number): any {
    ...
    this.msService.loadSampleSubmittedList(String(page), String(records)).subscribe(
