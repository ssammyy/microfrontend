...
// Hod Reject
  ...
  onClickSubmitForApproval() {
    this.msService.showSuccessWith2Message('Are you sure your want to Submit for approval?', 'You won\'t be able to revert Update Complaint Schedule after submission!',
        // tslint:disable-next-line:max-line-length
        'You can go back and  update the work-Plan Before Saving', 'BS NUMBER ADDING ENDED SUCCESSFUL', () => {
