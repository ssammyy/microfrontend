...
@Component({
    selector: 'app-source-for-standard',
    templateUrl: './source-for-standard.component.html',
    styleUrls: ['./source-for-standard.component.css']
})
export class SourceForStandardComponent implements OnInit {
    ...
    submit() {
        this.qaService.showSuccess("Available Standards Shared With Customer")
        this.hideModel()
    }

    send() {
        this.qaService.showSuccess("Payment Received")
        this.hideModel()
    }

    invoiceGenerate() {
        this.qaService.showSuccess("Proforma Invoice Generated")
        this.hideModel()
    }
