...
@Component({
  selector: 'app-system-review-gazette-standard',
  templateUrl: './system-review-gazette-standard.component.html',
  styleUrls: ['./system-review-gazette-standard.component.css']
})
export class SystemReviewGazetteStandardComponent implements OnInit {
  ...
  updateGazette(): void {
    ...
    this.SpinnerService.show();
    this.stdReviewService.updateGazette(this.gazetteFormGroup.value).subscribe(
        (response) => {
