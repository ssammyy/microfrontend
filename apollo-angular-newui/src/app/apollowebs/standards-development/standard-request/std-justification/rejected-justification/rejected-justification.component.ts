...
@Component({
  selector: 'app-rejected-justification',
  templateUrl: './rejected-justification.component.html',
  styleUrls: ['./rejected-justification.component.css']
})
export class RejectedJustificationComponent implements OnInit {
