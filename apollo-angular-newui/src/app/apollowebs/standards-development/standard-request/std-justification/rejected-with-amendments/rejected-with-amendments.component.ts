...
@Component({
    ...
    templateUrl: './rejected-with-amendments.component.html',
    styleUrls: ['./rejected-with-amendments.component.css']
})
export class RejectedWithAmendmentsComponent implements OnInit {
