...
declare const $: any;
@Component({
  selector: 'app-int-std-web-proposal',
  templateUrl: './int-std-web-proposal.component.html',
  styleUrls: ['./int-std-web-proposal.component.css']
})
export class IntStdWebProposalComponent implements OnInit {
  submitted = false;
  ...
  public getWebProposals(): void{
    this.loadingText = "Retrieving Proposals ...."
    this.SpinnerService.show();
    this.stdIntStandardService.getWebProposals().subscribe(
  ...
  onSubmit(): void {
    ...
    this.stdIntStandardService.submitWebsiteComments(this.uploadCommentsFormGroup.value).subscribe(
        (response ) => {
