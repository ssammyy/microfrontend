...
@Component({
    selector: 'app-review-applications-accepted',
    templateUrl: './review-applications-accepted.component.html',
    styleUrls: ['./review-applications-accepted.component.css']
})
export class ReviewApplicationsAcceptedComponent implements OnInit {
    p = 1;
    p2 = 1;
