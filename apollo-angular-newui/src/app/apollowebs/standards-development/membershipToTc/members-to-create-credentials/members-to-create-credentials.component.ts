...
@Component({
  selector: 'app-members-to-create-credentials',
  templateUrl: './members-to-create-credentials.component.html',
  styleUrls: ['./members-to-create-credentials.component.css']
})
export class MembersToCreateCredentialsComponent implements OnInit {
  ...
  public getApplicationsForReview(): void {
    ...
    this.membershipToTcService.getMembersToCreateCredentials().subscribe(
  ...
  public decisionOnApplications(reviewApplicationTask: ReviewApplicationTask, tCApplicationId: number, decision: string): void {
    ...
    this.SpinnerService.show();
    this.loadingText = "Creating Credentials";
    this.membershipToTcService.decisionOnCreateCredentials(reviewApplicationTask, tCApplicationId).subscribe(
        (response) => {
          console.log(response);
          this.getApplicationsForReview();
          this.SpinnerService.hide();
          this.notifyService.showSuccess("Success", 'Credentials Created')
