...
@Component({
    ...
    templateUrl: './scheme-membership-review.component.html',
    styleUrls: ['./scheme-membership-review.component.css']
})
export class SchemeMembershipReviewComponent implements OnInit {
