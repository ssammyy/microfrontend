...
@Component({
    selector: 'app-scheme-membership-review-assigned-applications',
    templateUrl: './scheme-membership-review-assigned-applications.component.html',
    styleUrls: ['./scheme-membership-review-assigned-applications.component.css']
})
export class SchemeMembershipReviewAssignedApplicationsComponent implements OnInit {
    ...
    public getApplicationsForReview(): void {
        ...
        this.schemeMembershipService.getHodTasksAssigned().subscribe(
