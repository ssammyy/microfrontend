...
declare const $: any;
@Component({
  selector: 'app-dmark-renewal-applications',
  templateUrl: './dmark-renewal-applications.component.html',
  styleUrls: ['./dmark-renewal-applications.component.css']
})
export class DmarkRenewalApplicationsComponent implements OnInit {
