...
@Component({
  selector: 'app-fmark-all-awarded-applications',
  templateUrl: './fmark-all-awarded-applications.component.html',
  styleUrls: ['./fmark-all-awarded-applications.component.css']
})
export class FmarkAllAwardedApplicationsComponent implements OnInit {
