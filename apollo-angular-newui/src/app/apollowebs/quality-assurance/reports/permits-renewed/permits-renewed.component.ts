...
@Component({
    selector: 'app-permits-renewed',
    templateUrl: './permits-renewed.component.html',
    styleUrls: ['./permits-renewed.component.css']
})
export class PermitsRenewedComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.sMarkFormInit()
        this.fMarkFormInit()
        this.getAllDMarkApplicationsRenewed()
        this.getAllFMarkApplicationsRenewed()
        this.getAllSMarkApplicationsRenewed()
    ...
    public getAllDMarkApplicationsRenewed(): void {
        this.SpinnerService.show();
        this.qaService.loadPermitRenewedReports(String(this.dMarkID)).subscribe(
    ...
    public getAllSMarkApplicationsRenewed(): void {
        this.qaService.loadPermitRenewedReports(String(this.sMarkID)).subscribe(
            (response: ReportsPermitEntityDto[]) => {
    ...
    public getAllFMarkApplicationsRenewed(): void {
        this.qaService.loadPermitRenewedReports(String(this.fMarkID)).subscribe(
            (response: ReportsPermitEntityDto[]) => {
    ...
    applyFilterSmark(formDirective): void {
        ...
        if (!this.errorSMark) {
            ...
            this.qaService.applyFilterRenewed(this.filterFormGroupSMark.value).subscribe(
                (response: ReportsPermitEntityDto[]) => {
                    this.spinnerService.hide();
                    this.allSMarkPermitData = response;
                    this.rerender()
