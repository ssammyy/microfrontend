...
declare const $: any;
@Component({
  selector: 'app-smark-renewal-applications',
  templateUrl: './smark-renewal-applications.component.html',
  styleUrls: ['./smark-renewal-applications.component.css']
})
export class SmarkRenewalApplicationsComponent implements OnInit {
