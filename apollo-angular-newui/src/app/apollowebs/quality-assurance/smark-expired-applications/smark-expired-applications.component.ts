...
declare const $: any;
@Component({
  selector: 'app-smark-expired-applications',
  templateUrl: './smark-expired-applications.component.html',
  styleUrls: ['./smark-expired-applications.component.css']
})
export class SmarkExpiredApplicationsComponent implements OnInit {
