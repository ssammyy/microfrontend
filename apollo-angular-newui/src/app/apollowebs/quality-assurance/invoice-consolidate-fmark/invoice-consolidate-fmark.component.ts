...
@Component({
  selector: 'app-invoice-consolidate-fmark',
  templateUrl: './invoice-consolidate-fmark.component.html',
  styleUrls: ['./invoice-consolidate-fmark.component.css']
})
export class InvoiceConsolidateFmarkComponent implements OnInit {
  ...
  public getSPCTasks(): void {
    ...
    this.SpinnerService.show();
    this.qaService.loadInvoiceListWithNoBatchIDPermitType(this.FMarkTypeID, this.branchID).subscribe(
