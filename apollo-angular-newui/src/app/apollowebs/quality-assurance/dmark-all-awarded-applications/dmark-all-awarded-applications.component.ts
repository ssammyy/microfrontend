...
@Component({
  selector: 'app-dmark-all-awarded-applications',
  templateUrl: './dmark-all-awarded-applications.component.html',
  styleUrls: ['./dmark-all-awarded-applications.component.css']
})
export class DmarkAllAwardedApplicationsComponent implements OnInit {
