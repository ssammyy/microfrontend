...
import {ApproveVisitTask, ReportDecisionLevelOne} from "../../../core/store/data/levy/levy.model";
...
@Component({
  selector: 'app-standard-levy-site-visit-approve-one',
  templateUrl: './standard-levy-site-visit-approve-one.component.html',
  styleUrls: ['./standard-levy-site-visit-approve-one.component.css']
})
export class StandardLevySiteVisitApproveOneComponent implements OnInit {
  ...
  public getSiteReport(): void{
    this.SpinnerService.show();
    this.levyService.getSiteReport().subscribe(
