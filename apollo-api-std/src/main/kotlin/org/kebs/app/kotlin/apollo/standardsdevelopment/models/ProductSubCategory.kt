...
@Entity
@Table(name = "SD_PRODUCT_SUB_CATEGORY")
class ProductSubCategory {
    ...
    override fun toString(): String {
        return "ProductSubCategory(id=$id, name=$name, description=$description, standardRequest=$standardRequest, status=$status, varField1=$varField1, varField2=$varField2, varField3=$varField3, varField4=$varField4, varField5=$varField5, varField6=$varField6, varField7=$varField7, varField8=$varField8, varField9=$varField9, varField10=$varField10, createdBy=$createdBy, createdOn=$createdOn, modifiedBy=$modifiedBy, modifiedOn=$modifiedOn, deleteBy=$deleteBy, deletedOn=$deletedOn, product=$product)"
    }
