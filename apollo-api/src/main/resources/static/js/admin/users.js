...
app.value('maxSize', 5);
app.value('authoritiesUrl', '/api/system/admin/security/authorities/load');
app
    .factory('dataFactory', ['$http', '$log', function ($http, $log) {

        const urlBase = '/api/system/admin/security/';
        const masterDataBaseUrl = '/api/system/admin/masters/';
        ...
        dataFactory._revokeAuthority = (roleId, authorityId, status) => {
            const method = "POST";
            const url = "/api/system/admin/security/rbac/revoke/" + roleId + "/" + authorityId + "/" + status;
        ...
        dataFactory._refreshActiveRolesData = status => $http({
            method: 'GET',
            url: "/api/system/admin/security/rbac/fetch/roles/" + status
        });

        dataFactory._refreshActiveAuthoritiesData = (roleId, status) => $http({
            method: 'GET',
            url: "/api/system/admin/security/rbac/fetch/authorities/" + roleId + "/" + status
        });

        dataFactory.loadActiveRbacUsers = status => $http({
            method: 'GET',
            url: "/api/system/admin/security/rbac/fetch/users/" + status
        })

        dataFactory.loadActiveRbacUserRoles = (userId, status) => $http({
            method: 'GET',
            url: "/api/system/admin/security/rbac/fetch/user-roles/" + userId + "/" + status
        })
        ...
        dataFactory.submitUserTypeData = userTypeForm => {
            ...
            let method;
            let url = "/api/system/admin/security/userTypes/";
        ...
        dataFactory.submitTitleData = titleForm => {
            ...
            let method;
            let url = "/api/system/admin/security/titles/";
        ...
        dataFactory.submitAuthorityData = authorityForm => {
            ...
            let method;
            let url = '/api/system/admin/security/authorities/';
        ...
        dataFactory.submitRoleData = roleForm => {
            ...
            if (roleForm.id === -1) {
                method = "POST";
                url = "/api/system/admin/security/roles/";
            } else {
                method = "PUT";
                url = "/api/system/admin/security/roles/";
            }
        ...
        dataFactory.submitUserData = userForm => {
            ...
            if (userForm.id === -1) {
                method = "POST";
                url = "/api/system/admin/security/users/";
            } else {
                method = "PUT";
        ...
        dataFactory.submitDesignationsData = designationForm => {
            let method;
            let url = "/api/system/admin/masters/designations/";
        ...
        dataFactory.submitDepartmentsData = departmentsForm => {
            let method;
            let url = "/api/system/admin/masters/departments/";
        ...
        dataFactory.submitDivisionsData = divisionsForm => {
            let method;
            let url = "/api/system/admin/masters/divisions/";
        ...
        dataFactory.submitDirectorateData = directorateForm => {
            let method;
            let url = "/api/system/admin/masters/directorate/";
        ...
        dataFactory.submitRegionsData = regionsForm => {
            let method;
            let url = "/api/system/admin/masters/regions/";
            if (regionsForm.id === -1) {
                method = "POST";
            } else {
                method = "PUT";
        ...
        dataFactory.submitSubRegionsData = subRegionsForm => {
            let method;
            let url = "/api/system/admin/masters/subRegions/";
        ...
        dataFactory.submitSectionsData = sectionsForm => {
            let method;
            let url = "/api/system/admin/masters/sections/";
        ...
        dataFactory.submitSubSectionsL1Data = subSectionsL1Form => {
            let method;
            let url = "/api/system/admin/masters/subsections/l1/";
        ...
        dataFactory.submitSubSectionsL2Data = subSectionsL2Form => {
            let method;
            let url = "/api/system/admin/masters/subsections/l2/";
        ...
        dataFactory.submitCountiesData = countiesForm => {
            let method;
            let url = "/api/system/admin/masters/counties";
        ...
        dataFactory.submitTownsData = townsForm => {
            let method;
            let url = "/api/system/admin/masters/towns";
            if (townsForm.id === -1) {
                method = "POST";
            } else {
                method = "PUT";
    ...
    .config(function ($routeProvider) {
        let adminBaseUrl = "/api/system/admin";
