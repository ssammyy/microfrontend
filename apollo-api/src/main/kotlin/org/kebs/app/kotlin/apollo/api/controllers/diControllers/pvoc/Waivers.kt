...
//            pvocWaiverDocument: PvocApplicationDocumentsEntity
//    ): String {
...
//            model.addAttribute("documents", iPvocApplicationDocumentRepo.findAllByWaiverId(report.id))
...
//    ): String {
//        val pvocWaiversApplicationDocumentsEntity = PvocApplicationDocumentsEntity()
...
//                iPvocApplicationDocumentRepo.save(pvocWaiversApplicationDocumentsEntity)
//                return "redirect:/api/di/pvoc/add-musterlist-details/${id}"
//            }
...
//        @RequestParam("id") id: Long
//    ) {
//        iPvocApplicationDocumentRepo.findFirstByWaiverIdAndReason(id, "master")
//            .let { doc ->
