...
//
//        val cdItemID = req.paramOrNull("cdItemID")?.toLong()
//                ?: throw ExpectedDataNotFound("Required cd Item ID, check config")
...
//        req.attributes()["LabResultsParameters"] = qaDaoServices.findSampleLabTestResultsRepoBYBSNumber(ssfDetails.bsNumber
