    ...
    fun migrationQualityAssuranceRoutes(
        ...
        "/api/v1/migration/qa".nest {
            ...
            "/company".nest {
                ...
                GET("/status-upgrade", handler::handleGetCompanyStatusUpgradeDetails)
                GET("/approval-request-upgrade", handler::handleActionUpdateCompanyTurnOverDetails)
                POST("/manf-requested-to-upgrade", handler::handleRequestUpdateCompanyTurnOverDetails)
                POST("/officer-requested-to-upgrade", handler::handleRequestUpdateCompanyTurnOverDetailsOfficer)
                POST("/update-turn-over", handler::handleUpdateCompanyTurnOverDetails)
...
//                    GET("/section-list", internalUserhandler::getPermitDetails)
                }
                "/apply".nest {
                    "/permit".nest {
                        ...
                        "/inspection".nest {
                            POST("/new-technical-report", internalUserhandler::updatePermitDetailsInspectionCheckListNew)
                            POST("/process-step-add", handler::permitProcessStepMigration)
                            ...
                            POST("/standardiztion-mark-scheme", internalUserhandler::updateInspectionReportStandardizationMarkSchemeSave)
                            POST("/operationProcessAndControls", internalUserhandler::updateInspectionCheckListInspectionReportDetailsOPCSave)
                            POST("/haccpImplementationDetails", internalUserhandler::updateInspectionCheckListInspectionHACCPImplementationSave)
                        }
