...
class UserSpecification(private val criteria: SearchCriteria) : Specification<UsersEntity?> {


    override fun toPredicate(root: Root<UsersEntity?>, query: CriteriaQuery<*>, builder: CriteriaBuilder): Predicate? {
        when {
